(function($) {
    ...
    */
    ...
    $('#button_more').click(function () { $.scrollTo('#features_3',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});
    $('#button_signup').click(function () { $.scrollTo('#footer',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});
    ...
    $('#features_3_arrow_back').click(function () { $.scrollTo('#home',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});
